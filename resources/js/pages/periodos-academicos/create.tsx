    ...
    <AppLayout>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Crear Período Académico</h2>
            <p className="text-muted-foreground">
              Agrega un nuevo período académico al sistema
            </p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Completa los datos del período académico
            </CardDescription>
          </CardHeader>
          <CardContent>
